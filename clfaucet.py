...
FROM_ACCOUNT = "dip1gjzd9j4xhut7uwgrsf0lavyfmjw8cun0j2h3yq"
#FROM_ACCOUNT = "dip1d4rne4g0jd7jxceulcad0cn3t56pstrh3a0g3c"
...
class GetTokenHandler(tornado.web.RequestHandler):
  ...
  def _os_cmd_transfer(self, param):
    cmd = 'echo "%s" |  dipcli send --from %s --to %s --amount %dudip --gas-prices 0.001udip --memo "for test" -y' % (PASSWD, FROM_ACCOUNT, param['to'], param['quantity'])
